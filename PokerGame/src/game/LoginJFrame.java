...
public class LoginJFrame extends JFrame implements MouseListener {
	...
	*/
        allUser.add(new User("12345","12345"));
        allUser.add(new User("54321","54321"));
    }
    ...
    JTextField code = new JTextField();//验证码框
    ...
    public void initView() {
        ...
        login.setIcon(new ImageIcon("PokerGame\\image\\login\\登录按钮.png"));
        //去除按钮的边框
        ...
        register.setIcon(new ImageIcon("PokerGame\\image\\login\\注册按钮.png"));
        //去除按钮的边框
        ...
        //7.添加背景图片
        JLabel background = new JLabel(new ImageIcon("PokerGame\\image\\login\\background.png"));
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if (obj == login){
            ...
            if (!code.equalsIgnoreCase(rightCode.getText())){
                showJDialog("验证码错误！");
                rightCode.setText(CodeUtil.getCode());
                return;
            }
            if (allUser.contains(new User(username,password))){
                new GameJFrame();
                dispose();
            }else {
    ...
    public void mousePressed(MouseEvent e) {
        if (e.getSource() == login) {
            login.setIcon(new ImageIcon("PokerGame\\image\\login\\登录按下.png"));
        } else if (e.getSource() == register) {
            register.setIcon(new ImageIcon("PokerGame\\image\\login\\注册按下.png"));
        }
    }
